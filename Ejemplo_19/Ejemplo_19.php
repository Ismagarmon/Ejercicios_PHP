...
$a[]="¿Será este tercero?"; 
# comprobemos que le ha puesto índice 3 echo "El elemento ".$a[3]." tiene indice 3 (siguiente a 2) <br>"; 
# ahora insertemos un nuevo elemento con indice 32 $a[32]="Mi indice es 32"; 
...
# comprobemos que efectivamente ha empezado con indice CERO print ($b[0]."<br>"); 
...
#encadenemos variables para hacer una salida pondremos cadenas " " para que no aparezcan los textos 
...
# tratemos ahora de visualizar esa variable # probemos a escribir $c[0] porque PHP # habrá entendido que queremos un array escalar 
