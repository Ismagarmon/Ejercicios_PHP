...
<body>
    <?php
        ...
        foreach($claves1 as $v){ 
            echo "El valor ",$v," es una de las claves de elementos de la matriz cuyo valor es <b>1</b><br>"; 
        }

        echo "<h3>Devuelve los valores de un array</h3>"; 
        $valores = array_values($c); 
        foreach($valores as $v){ 
            echo $v," Este es un de los valores de la matriz c<br>"; 
        }
